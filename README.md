...
| 类别         | 能力                                                    |
| ------------ | ------------------------------------------------------- |
| 📝 Story    | 需求管理 - 创建、查询、更新需求                            |
| 🐛 Bug      | Bug 管理 - 创建、查询、更新 Bug                           |
| ✅ Task      | 任务管理 - 查看和管理任务                                 |
| 📦 Product  | 产品管理 - 查看和管理产品                                 |
| 🏗️ Project | 项目管理 - 查看和管理项目                                 |
| 👤 User     | 用户管理 - 查看用户信息                                   |
| 🧪 Testcase | 测试用例管理 - 查看测试用例                               |
| ▶️ Execution | 执行管理 - 查看执行进度                                   |
| 🎉 Release  | 发布管理 - 查看发布信息                                   |
| 🔨 Build    | 构建管理 - 查看构建信息                                   |
| 📄 Doc      | 文档管理 - 查看和管理文档                                 |
...
| `zentao-story`    | 需求管理 - 列出、查看、创建、更新需求                                      |
| `zentao-bug`      | Bug 管理 - 列出、查看、创建、更新 Bug                                     |
| `zentao-task`     | 任务管理 - 列出、查看、创建、更新任务                                      |
| `zentao-product`  | 产品管理 - 列出、查看产品信息                                             |
| `zentao-project`  | 项目管理 - 列出、查看项目信息                                             |
| `zentao-user`     | 用户管理 - 列出、查看用户信息                                             |
| `zentao-testcase` | 测试用例 - 列出、查看测试用例                                            |
| `zentao-execution`| 执行管理 - 列出、查看执行进度                                            |
| `zentao-release`  | 发布管理 - 列出、查看发布信息                                             |
| `zentao-build`    | 构建管理 - 列出、查看构建信息                                            |
