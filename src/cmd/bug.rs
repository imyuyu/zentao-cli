...
pub fn run(cmd: &BugSubcommand, config: &Config, _format: OutputFormat) {
    ...
    rt.block_on(async {
        ...
        match cmd {
            // -------------------- list --------------------
            BugSubcommand::List { product, status, assigned_to } => {
            ...
            // -------------------- create --------------------
            BugSubcommand::Create { title, product, severity, pri, type_, steps, story } => {
            ...
            // -------------------- update --------------------
            BugSubcommand::Update { id, title, status, resolution, assigned_to } => {
